...
# Data Load
eee_infile = "/home/bjpark/WZG/ML/preprocess/eee_binary.h5" 
eem_infile = "/home/bjpark/WZG/ML/preprocess/eem_binary.h5" 
emm_infile = "/home/bjpark/WZG/ML/preprocess/emm_binary.h5" 
mmm_infile = "/home/bjpark/WZG/ML/preprocess/mmm_binary.h5" 
...
eee_eta = eee_df['lep2_eta']
eem_eta = eem_df['lep2_eta']
emm_eta = emm_df['lep2_eta']
mmm_eta = mmm_df['lep2_eta']

# Remove unnecessary columns
eee_df = eee_df.drop(['lep1_F', 'lep2_F', 'lep2_eta'], axis=1)
eem_df = eem_df.drop(['lep1_F', 'lep2_F', 'lep2_eta'], axis=1)
emm_df = emm_df.drop(['lep1_F', 'lep2_F', 'lep2_eta'], axis=1)
mmm_df = mmm_df.drop(['lep1_F', 'lep2_F', 'lep2_eta'], axis=1)

eee_df['lep2_eta'] = eee_eta
eem_df['lep2_eta'] = eem_eta
emm_df['lep2_eta'] = emm_eta
mmm_df['lep2_eta'] = mmm_eta
