...
plt.axvline(x=0.74, color='black', linestyle=':', linewidth=2, label='Threshold')
...
plt.axvline(x=0.66, color='black', linestyle=':', linewidth=2, label='Threshold')
plt.title("$\sqrt{s}=14$ TeV, L=3000 $fb^{-1}$", fontsize=13, loc='right')
plt.xlabel('DNN score', fontsize=17)
plt.ylabel('Expected Number of Events', fontsize=17)
plt.ylim(0.1, 1000)
...
plt.axvline(x=0.62, color='black', linestyle=':', linewidth=2, label='Threshold')
plt.title("$\sqrt{s}=14$ TeV, L=3000 $fb^{-1}$", fontsize=13, loc='right')
plt.xlabel('DNN score', fontsize=17)
plt.ylabel('Expected Number of Events', fontsize=17)
plt.ylim(0.1, 1000)
...
plt.axvline(x=0.92, color='black', linestyle=':', linewidth=2, label='Threshold')
plt.title("$\sqrt{s}=14$ TeV, L=3000 $fb^{-1}$", fontsize=13, loc='right')
plt.xlabel('DNN score', fontsize=17)
