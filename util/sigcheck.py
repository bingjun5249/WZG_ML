...
eee_infile = '/home/bjpark/WZG/ML/storage/run_files/'+trial+'/eee/eee_prediction.csv'
eem_infile = '/home/bjpark/WZG/ML/storage/run_files/'+trial+'/eem/eem_prediction.csv'
emm_infile = '/home/bjpark/WZG/ML/storage/run_files/'+trial+'/emm/emm_prediction.csv'
mmm_infile = '/home/bjpark/WZG/ML/storage/run_files/'+trial+'/mmm/mmm_prediction.csv'
...
eee_SF = 113.5781377833493
eem_SF = 140.04911604398688
emm_SF = 122.91932303976394
mmm_SF = 137.4726888290324
lumi = 3000000
genevt = 9899604
xsex = 0.00173
...
plt.axvline(x=0.80, color='black', linestyle=':', linewidth=2, label='Threshold')
plt.title("$\sqrt{s}=14$ TeV, L=3000 $fb^{-1}$", fontsize=13, loc='right')
plt.xlabel('DNN score', fontsize=17)
plt.ylabel('Expected Number of Events', fontsize=17)
plt.ylim(0.1, 1000)
...
plt.rcParams["legend.loc"] = 'lower left'
plt.plot(list([round(i*0.02,2) for i in range(0,50)]),eem_arr_sig,'-.',color='blue', linewidth=2)
plt.xlabel('DNN score',fontsize=25)
plt.ylabel('Expected Significance',fontsize=25)
