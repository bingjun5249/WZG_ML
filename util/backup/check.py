...
eee_infile = '/x4/cms/dylee/Delphes/ML/Node06_Machine_Learning/mix_ML/run/most/eee/prediction.csv'
eem_infile = '/x4/cms/dylee/Delphes/ML/Node06_Machine_Learning/mix_ML/run/most/eem/prediction.csv'
emm_infile = '/x4/cms/dylee/Delphes/ML/Node06_Machine_Learning/mix_ML/run/most/emm/prediction.csv'
mmm_infile = '/x4/cms/dylee/Delphes/ML/Node06_Machine_Learning/mix_ML/run/most/mmm/prediction.csv'
...
eee_hbkg = plt.hist(eee_df_bkg['prediction'], histtype='step', weights=eee_df_bkg['weight']*5/eee_SF, bins=50,linewidth=3, color='crimson', label='BKG')
eee_hsig = plt.hist(eee_df_sig['prediction'], histtype='step', weights=eee_df_sig['weight']*5 * lumi * xsex/genevt, bins=50,linewidth=3, color='royalblue', label='SIG')
...
eem_hbkg = plt.hist(eem_df_bkg['prediction'], histtype='step', weights=eem_df_bkg['weight']*5/eem_SF, bins=50,linewidth=3, color='crimson', label='BKG')
eem_hsig = plt.hist(eem_df_sig['prediction'], histtype='step', weights=eem_df_sig['weight']*5 * lumi * xsex/genevt, bins=50,linewidth=3, color='royalblue', label='SIG')
...
emm_hbkg = plt.hist(emm_df_bkg['prediction'], histtype='step', weights=emm_df_bkg['weight']*5/emm_SF, bins=50,linewidth=3, color='crimson', label='BKG')
emm_hsig = plt.hist(emm_df_sig['prediction'], histtype='step', weights=emm_df_sig['weight']*5 * lumi * xsex/genevt, bins=50,linewidth=3, color='royalblue', label='SIG')
...
mmm_hbkg = plt.hist(mmm_df_bkg['prediction'], histtype='step', weights=mmm_df_bkg['weight']*5/mmm_SF, bins=50,linewidth=3, color='crimson', label='BKG')
mmm_hsig = plt.hist(mmm_df_sig['prediction'], histtype='step', weights=mmm_df_sig['weight']*5 * lumi * xsex/genevt, bins=50,linewidth=3, color='royalblue', label='SIG')
