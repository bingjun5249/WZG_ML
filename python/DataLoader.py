...
## Read ntuple
infile = "/home/bjpark/WZG/ML/data/eee_binary.h5"
...
train_w = train_df.iloc[:, [-2]].values

# Validation data
val_x = val_df.iloc[:, 3:-4].values 
val_y = val_df.iloc[:,[0]].values 
val_w = val_df.iloc[:, [-2]].values

test_df = test_df.reset_index(drop=True)

# Test data
test_x = test_df.iloc[:, 3:-4].values 
test_y = test_df.iloc[:,[0]].values 
test_w = test_df.iloc[:, [-2]].values
...
test_df.to_hdf('eee_testset.h5', key = 'df', mode = 'w')
